...
(define-library (chibi math stats-test)
  ...
  (begin
    ...
    (define (run-tests)
      ...
      (test 20000.0 (square-sum (list*->array 1 (make-list 10000 (sqrt 2)))))
      ...
      (test 3 (mean (list*->array 2 '((1 2) (3 3) (4 5)))))
      ...
      (test #t (array? (random-sample 3 (list*->array 1 '(1 2 3 4 5)))))
      (test 5 (length (random-sample 5 '(1 2 3 4 5))))
      (test 5 (vector-length (random-sample 5 '#(1 2 3 4 5))))
      (test 5 (interval-volume (array-domain (random-sample 5 (list*->array 1 '(1 2 3 4 5))))))
      ...
      (test #t (array? (random-multi-sample 3 (list*->array 1 '(1 2 3 4 5)))))
      (test 7 (length (random-multi-sample 7 '(1 2 3 4 5))))
      (test 7 (vector-length (random-multi-sample 7 '#(1 2 3 4 5))))
      (test 7 (interval-volume (array-domain (random-multi-sample 7 (list*->array 1 '(1 2 3 4 5))))))
      ...
      (let ((sample (summary-distribution 'mean: 96 'size: 55))
        ...
        (test -1.1547005383792517 (z-statistic sample dist))
        (test 0.12410653949496181 (z-test sample dist))
        (test 0.24821307898992362 (z-test sample dist 2))
        (test-not (z-test? sample dist)))
      (test 9107.30
          (covariance '#(1692 1978 1884 2151 2519) '#(68 102 110 112 154)))
      (test 9107.30
          (covariance (list*->array 1 '(1692 1978 1884 2151 2519))
                      (list*->array 1 '(68 102 110 112 154))))
