      ...
      (test-group "(chibi chrono)"
        (let* ((instant 1631107018)
          ...
          (test-group "basic"
            ...
            (test 251 (temporal-ref dt 'day-of-year))
            (test 2 (temporal-ref dt 'week-of-month))
            (test 37 (temporal-ref dt 'week-of-year))
            (test 2459466 (temporal-ref dt 'julian-day))
            (test 1 (temporal-ref (make-date 2021 1 1) 'day-of-year))
            (test 365 (temporal-ref (make-date 2021 12 31) 'day-of-year))
            (test 1 (temporal-ref (make-date 2021 1 1) 'week-of-year))
            (test 1 (temporal-ref (make-date 2021 1 2) 'week-of-year))
            (test 2 (temporal-ref (make-date 2021 1 3) 'week-of-year))
            (test 1 (temporal-ref (make-date 2021 9 1) 'week-of-month))
            (test 1 (temporal-ref (make-date 2021 9 2) 'week-of-month))
            (test 1 (temporal-ref (make-date 2021 9 3) 'week-of-month))
            (test 1 (temporal-ref (make-date 2021 9 4) 'week-of-month))
            (test 2 (temporal-ref (make-date 2021 9 5) 'week-of-month))
            (test 2 (temporal-ref (make-date 2021 9 11) 'week-of-month))
            (test 3 (temporal-ref (make-date 2021 9 12) 'week-of-month))
